...
class Cetak_nilai extends CI_Controller
{
  ...
  public function index()
  {
        ...
        if( $this->tipe_user != '3'){
          ...
          $data['mata_kuliah_terkunci'] =$this->cetak_nilai_model->get_mata_kuliah_terkunci();
          
          //isi konten
          $data['isicontent'] = 'e_dosen/cetak_nilai/_cetak_nilai';
  ...
  public function rincian_data_nilai($id_jadual='')
  {
        ...
        if( $this->tipe_user != '3' || empty($id_jadual)){
          redirect('/e_dosen');
        }
        ...
        if (!is_numeric($id_jadual)) {
          ...
          */
          ...
          //isi konten
          $data['isicontent'] = 'e_dosen/cetak_nilai/_cetak_nilai_rincian_mhs';
          $data['menu_header'] = $this->menu_otomatis->create_menu_admin(0, 1, 'menu_admin_elearning_dosen');
          $this->load->view('e_dosen/_layout',$data);
  ...
  public function jumlah_update_cetak()
  {
        if (!$this->tank_auth->is_logged_in()) {
          redirect('/auth/login/');
        }
  ...
  public function ubah_url()
  {
        ...
        //$this->cetak_nilai_model->update_cetak_nilai($id_jadual);
        //<form action="" method="post" id="url_nilai" target="_blank">
        $data=base_url().'e_dosen/cetak_nilai/rincian_data_nilai/'.my_number_encrypt($id_jadual);
        echo $data;
