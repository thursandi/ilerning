...
:?>
                                            <option value="<?php echo $row->id_jadual; ?>" <?php echo (empty($row->status) || $row->status==0)? '': 'disabled'; ?>>
...
?>
                            ...
                            <tr>
                              ...
                              <td>
								...
								<br>Tugas : 20-30% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; UTS : 30-40% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; UAS : 35-45%
                            ...
                            <tr>
                              <td></td>
                              <td><button type="submit" class="btn blue" id="ok_total" disabled="disabled" onclick="urlUbah();"><i class="icon-ok"></i> Input Nilai Mahasiswa</button></td>
                            </tr>
                          </table>
                          </form>
                          <!-- Rincian Matkul Dosen -->
...
$('#pilihan_matkul').on("change",function() {
   ...
   if (a!=0) {
    ...
    $.ajax({
                ...
                url : "<?php echo base_url();?>/e_dosen/input_nilai/cek_bobot",
  ...
  function urlUbah() {
      ...
      if (a!=0) {
        ...
        $.ajax({
                ...
                url : "<?php echo base_url();?>/e_dosen/input_nilai/ubah_url",
                cache : false,
    ...
    $(".input-mini").keyup(function() {
      ...
      if (a!=0) {
          ...
          var sum = parseInt($('input[name=bobot_tugas]').val(), 10);
              ...
              sum = isNaN(sum) ? 'data krg' : sum;
              $("#total").val(sum);
			  var tugas = parseInt($('input[name=bobot_tugas]').val(), 10);
			  var uts = parseInt($('input[name=bobot_uts]').val(), 10);
			  var uas = parseInt($('input[name=bobot_uas]').val(), 10);
			  if(tugas <20 || tugas >30){
				  b = 0;
			  }
			  else if(uts <30 || uts >40){
				  b = 0;
			  }
			  else if(uas <35 || uas >45){
				  b = 0;
			  }
			  else {
				  b = 1;
